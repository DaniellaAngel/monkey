...
label = pd.read_csv("dataset/GRF/JCUED03/enMatJCUED03_train_label.csv")
test_dataset = pd.read_csv("dataset/GRF/JCUED03/enMatJCUED03_test.csv")
test_label = pd.read_csv("dataset/GRF/JCUED03/enMatJCUED03_test_label.csv")
# dataset = pd.read_csv("dataset/GRF/JCUED03/JCUED03.csv")
# label = pd.read_csv("dataset/GRF/JCUED03/JCUED03_label.csv")

# dataset = pd.read_csv("dataset/GRF/JUNIWARD03/enMatJUNIWARD03_train.csv")
# label = pd.read_csv("dataset/GRF/JUNIWARD03/enMatJUNIWARD03_train_label.csv")
# test_dataset = pd.read_csv("dataset/GRF/JUNIWARD03/enMatJUNIWARD03_test.csv")
# test_label = pd.read_csv("dataset/GRF/JUNIWARD03/enMatJUNIWARD03_test_label.csv")
